...
consumer_key = 'SbsKjhOAkKRnooyvCmhO'
consumer_secret = 'HwIzpVlcTILmOWWnuDzIoVMzxLKhwmiy'
...
search_results = discogsclient.search('Maps', type='release', artist='Maroon+5')
